...
ArnoldC is a programming language based on the one-liners of Arnold Schwarzenegger. Although the one-liners of Arnold Schwarzenegger are fairly well known the true semantics of the uttering is yet to be understood. This language tries to discover new meanings from the Arnold movies with the means of computer science.
