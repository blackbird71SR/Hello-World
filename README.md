...
- [x] **ADVPL**
The ADVPL (Advanced Protheus Language) is a standard programming language xBase (Clipper, Visual Objects and then Fivewin) with commands, functions, operators, flow control structures and reserved words which allows the development that follow programs oriented paradigm objects or procedural.
The ADVPL is a programming language developed in 1994 for the development of ERP business management systems TOTVS group.
