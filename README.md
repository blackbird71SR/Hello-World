...
- [x] **Arrows**
[Arrows](https://github.com/JohnathonNow/arrows-esolang) is an esoteric programming language whose source files are images of arrows.  Programs run by "following" these arrows, doing a few simple stack, register, and i/o operations based on how these paths are shaped.
