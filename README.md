...
- Add code for your language with file name `HelloWorld(language).extension`, for example: `HelloWorld(Python).py` for python.
...
- [x] **Assembly**
An assembly language, often abbreviated asm, is any low-level 
programming language in which there is a very strong correspondence 
between the program's statements and the architecture's machine code instructions. Each assembly language is specific to a particular computer architecture and operating system.
...
- [x] **Lisp**
Lisp is a family of computer programming languages with a long history and a distinctive, fully paranthesized prefix notation.
...
- [x] **Perl**
Perl is a general-purpose Unix scripting language designed to make report processing easier.
...
- [x] **PostScript**
PostScript is a page description language in the electronic publishing and desktop publishing business. It is a dynamically typed, concatenative programming language.

- [x] **PowerShell**
PowerShell is a task automation and configuration management framework, consisting of a command-line shell and associated scripting language.
...
- [x] **SQL**
SQL is a domain-specific language used in programming and designed for managing data held in relational database management systems, or for stream processing in a relational data stream management system. 
...
- [x] **TypeScript**
TypeScript is an open-source programming language developed and maintained by Microsoft. It is strictly a syntactical superset of JavaScript, and adds optional static typing to the language.
