...
Python is an interpreted high-level programming language for general purpose programming. What an interpreted programming language here means is a type of programming language for which most of its instructions execute directly and freely, without previously compiling a program into a machine level instructions. It was created by Guido van Rossum and first released in 1991. Python has a design philosophy that emphasizes code readability, notably using significant whitespace. It provides constructs that enable clear programming on both small and large scales. 
...
Python interpreters are available for many operating systems. CPython, the reference implementation of Python, is open source software and has community based development model, as do nearly all Python's other implementations. Python and CPython are managed by the non-profit Python Software Foundations.
