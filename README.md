...
Named after the eighth circle of hell in Dante's Inferno, Malbolge is a public domain esoteric programming language invented by Ben Olmstead in 1998. It was specifically designed to be almost impossible to use and so difficult to understand that when it arrived it took two years for the first Malbolge program to appear. What's even more intriguing is that the first Malbolge program was not written by a human being but was generated by a beam search algorithm.
