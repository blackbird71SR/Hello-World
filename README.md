...
- Now create a new branch with this command: `git branch branch-name` and then use that branch by this command: `git checkout branch-name`.
- Go ahead and make changes.
- After making changes use this command to add the changes: `git add filename`, and then `git commit -m "message here"`.
- After that use this command: `git push origin branch-name`.
